...
const controller = __importStar(require("../controllers/performance-v2.controller"));
...
router.get('/team-target', (0, auth_middleware_1.requireRole)(70), controller.getTeamTargets);
router.post('/team-targets', (0, auth_middleware_1.requireRole)(70), controller.createTeamTarget);
router.get('/team-targets', (0, auth_middleware_1.requireRole)(70), controller.getTeamTargets);
// Employee Targets
router.post('/employee-target', (0, auth_middleware_1.requireRole)(70), controller.createEmployeeTarget);
router.post('/employee-targets', (0, auth_middleware_1.requireRole)(70), controller.createEmployeeTarget);
