...
router.get('/:id/risk-profile', (0, auth_middleware_1.requireSpecificRole)(['HR_DIRECTOR', 'HR_MANAGER', 'MD', 'DEV']), user_controller_1.getUserRiskProfile); // alias
...
router.post('/', (0, auth_middleware_1.requirePermission)(permissions_1.Permission.EMPLOYEE_WRITE), (0, validate_middleware_1.validate)(validate_middleware_1.CreateUserSchema), user_controller_1.createEmployee);
router.post('/:id/activate-login', (0, auth_middleware_1.requirePermission)(permissions_1.Permission.ACCOUNT_ACTIVATE), user_controller_1.activateEmployeeLogin);
// Update
...
router.post('/assign-role', (0, auth_middleware_1.requireSpecificRole)(['HR_DIRECTOR', 'MD', 'SUPER_ADMIN', 'DEV']), user_controller_1.assignRole);
