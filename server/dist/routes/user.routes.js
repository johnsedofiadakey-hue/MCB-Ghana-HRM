...
router.post('/', (0, auth_middleware_1.authorize)(['HR_MANAGER', 'HR_DIRECTOR', 'IT_MANAGER', 'MD']), (0, validate_middleware_1.validate)(validate_middleware_1.CreateUserSchema), user_controller_1.createEmployee);
// Update
