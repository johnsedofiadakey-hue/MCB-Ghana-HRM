...
router.get('/:id/risk', (0, auth_middleware_1.authorize)(['HR_OFFICER', 'HR_MANAGER', 'IT_MANAGER', 'MD']), user_controller_1.getUserRiskProfile);
router.get('/:id/risk-profile', (0, auth_middleware_1.authorize)(['HR_OFFICER', 'HR_MANAGER', 'IT_MANAGER', 'MD']), user_controller_1.getUserRiskProfile); // alias
// Create (HR Manager / IT Manager / MD only)
router.post('/', (0, auth_middleware_1.authorize)(['HR_MANAGER', 'IT_MANAGER', 'MD']), (0, validate_middleware_1.validate)(validate_middleware_1.CreateUserSchema), user_controller_1.createEmployee);
// Update
...
router.delete('/:id', (0, auth_middleware_1.authorize)(['HR_MANAGER', 'IT_MANAGER', 'DEV']), user_controller_1.deleteEmployee);
router.delete('/:id/hard', (0, auth_middleware_1.authorize)(['HR_MANAGER', 'IT_MANAGER', 'DEV']), user_controller_1.hardDeleteEmployee);
router.post('/:id/restore', (0, auth_middleware_1.authorize)(['HR_MANAGER', 'IT_MANAGER', 'DEV']), user_controller_1.restoreEmployee);
