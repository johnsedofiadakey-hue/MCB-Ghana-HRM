...
const SettingsHub = () => {
  ...
  const tabs: { id: SettingsTab; label: string; icon: any; description: string }[] = [
    ...
    // HR Managers see only the operational configurations above.
    ...((getRoleRankValue(currentUser?.role) >= 95 || (getRoleRankValue(currentUser?.role) >= 85 && (currentUser?.role || '').toUpperCase().includes('IT'))) ? [
            ...
            >
                  ...
                  <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="pt-20">
                        <div className="space-y-10">
                           ...
                           <div className="p-10 lg:p-14 bg-[var(--bg-elevated)]/30 rounded-[4rem] border-2 border-[var(--border-subtle)] border-dashed flex justify-center items-center min-h-[550px] relative overflow-hidden group/preview">
                               {/* Sophisticated Background Aesthetic */}
                               ...
                               <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,var(--primary)_0%,transparent_70%)] opacity-5 pointer-events-none" />
                               
                               <div className="relative z-10 transition-all duration-1000 transform scale-[0.75] lg:scale-[0.8] xl:scale-[0.85] hover:scale-[0.87] cursor-zoom-in">
                                 <EmployeeIDCard 
                                   employee={{ 
              ...
              <div className="mt-20 pt-10 border-t border-[var(--border-subtle)] flex items-center justify-between">
                <div className="hidden md:block">
                  <p className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-widest opacity-40 italic">System V5.2.9-GOLDEN-STATE-RESTORED Deployment Active</p>
                </div>
                <button
                  onClick={async () => {
                    setLoading(true);
